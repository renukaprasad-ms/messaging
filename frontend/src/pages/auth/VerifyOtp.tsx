...
const VerifyOtp = () => {
  ...
  const [error, setError] = useState(
    identifier ? '' : 'Please request a password reset code first.',
  )
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="mt-6 h-12 w-full rounded-xl bg-indigo-500 text-sm font-semibold text-white hover:bg-indigo-600 disabled:cursor-not-allowed disabled:bg-indigo-300"
        >
